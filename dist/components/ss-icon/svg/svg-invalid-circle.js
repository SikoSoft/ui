...
let SVGInvalidCircle = class SVGInvalidCircle extends LitElement {
    render() {
        return html `
...
SVGInvalidCircle = __decorate([
    customElement('svg-invalid-circle')
], SVGInvalidCircle);
export { SVGInvalidCircle };
//# sourceMappingURL=svg-invalid-circle.js.map